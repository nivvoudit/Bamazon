...
Bamazon [no trademark-infringement intended] is a Node.js & MySQL command line Amazon-like storefront app that basically collects customer orders and depletes stock from the stores Inventory.
